...
import { Target, Shield, Zap, Clock, TrendingUp, TrendingDown } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold text-white mb-2">Statistiche Partita</h2>
        <div className="flex items-center justify-center gap-4">
          <div className="text-center">
            <div className="text-sm text-gray-400">{match.homeTeam}</div>
            <div className="text-3xl font-bold text-white">{match.homeScore}</div>
          </div>
          <div className="text-gray-400">-</div>
          <div className="text-center">
            <div className="text-3xl font-bold text-white">{match.awayScore}</div>
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-semibold text-white mb-4">Statistiche Squadra</h3>
        
        {Object.entries(match.teamStats).map(([statName, values]) => (
          <div key={statName} className="flex items-center justify-between py-2 border-b border-gray-700">
            ...
            <div className="flex items-center gap-4">
              <div className={`text-right ${getStatColor(values.home, values.away)}`}>
                <div className="font-bold">{formatStatValue(values.home, statName)}</div>
              </div>
              ...
              <div className={`text-left ${getStatColor(values.away, values.home)}`}>
                <div className="font-bold">{formatStatValue(values.away, statName)}</div>
              </div>
            </div>
          </div>
        ))}
      ...
      {match.attackAreas && (
        <div className="mt-6">
          <h3 className="text-lg font-semibold text-white mb-4">Aree di Attacco</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-700 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{match.attackAreas.home.left}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Centro:</span>
                  <span className="text-white">{match.attackAreas.home.center}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Destra:</span>
                  <span className="text-white">{match.attackAreas.home.right}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-700 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-300">Sinistra:</span>
                  <span className="text-white">{match.attackAreas.away.left}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Centro:</span>
                  <span className="text-white">{match.attackAreas.away.center}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Destra:</span>
                  <span className="text-white">{match.attackAreas.away.right}%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {showPlayerRatings && match.playerRatings && (
        <div className="mt-6">
          <h3 className="text-lg font-semibold text-white mb-4">Valutazioni Giocatori</h3>
