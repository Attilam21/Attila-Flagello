...
const PlayerCard = ({ player, showDetails = false }) => {
  ...
  return (
    <div className={`bg-gray-800 rounded-xl p-4 border-2 ${getCardTypeColor(player.cardType)}`}>
      {/* Header */}
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">{player.team} {player.season}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <div className="bg-gray-700 rounded-lg p-2">
          ...
          <div className="text-lg font-bold text-white">{player.stats?.offensiveAwareness || 0}</div>
        </div>
        ...
        <div className="bg-gray-700 rounded-lg p-2">
          ...
          <div className="text-lg font-bold text-white">{player.stats?.defensiveAwareness || 0}</div>
        </div>
        ...
        <div className="bg-gray-700 rounded-lg p-2">
          ...
          <div className="text-lg font-bold text-white">{player.stats?.speed || 0}</div>
        </div>
        ...
        <div className="bg-gray-700 rounded-lg p-2">
          ...
          <div className="text-lg font-bold text-white">{player.stats?.stamina || 0}</div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-gray-600">
            <div className="text-center">
              ...
              <div className="text-sm font-bold text-white">{player.matchesPlayed}</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm font-bold text-white">{player.assists}</div>
            </div>
          </div>
        </div>
      )}
