    ...
    <div style={styles.container}>
      ...
      {showDetails && (
        <div style={{ marginTop: '1rem', padding: '1rem', backgroundColor: '#374151', borderRadius: '0.5rem' }}>
          <h4 style={{ color: '#E5E7EB', marginBottom: '0.5rem' }}>📊 Analisi Dettagliata</h4>
          <p style={{ color: '#9CA3AF', fontSize: '0.875rem' }}>
            Le statistiche mostrano le abilità del giocatore in diverse aree del gioco.
            Valori alti indicano prestazioni superiori in quella specifica competenza.
          </p>
        </div>
      )}
    </div>
