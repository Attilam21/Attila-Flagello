...
describe('AI Profiling Service', () => {
  ...
  it('should profile a player correctly', () => {
    const analysis = aiProfilingService.profilePlayer(mockPlayer, 'RW', mockTeamContext);
  ...
  it('should handle out-of-position players', () => {
    const analysis = aiProfilingService.profilePlayer(mockPlayer, 'CB', mockTeamContext);
  ...
  it('should handle incompatible builds', () => {
    ...
    const analysis = aiProfilingService.profilePlayer(defenderPlayer, 'RW', mockTeamContext);
  ...
  it('should handle inefficient boosters', () => {
    ...
    const analysis = aiProfilingService.profilePlayer(playerWithBadBoosters, 'RW', mockTeamContext);
...
describe('PlayerAnalysis Component', () => {
  const mockAnalysis = {
    ...
    assignedPosition: 'RW',
    naturalPosition: 'RW',
    roleCompatibility: { compatibility: 100, penalty: 0, reason: 'Ruolo naturale' },
    buildAnalysis: { compatibility: 90, penalty: 0, reason: 'Build ottimale' },
    boosterAnalysis: { efficiency: 85, waste: 0, suggestions: ['Booster ottimale'] },
    skillsAnalysis: { utilization: 90, unused: 0, suggestions: ['Abilità ben utilizzate'] },
    teamSynergy: { synergy: 80, connections: 2, suggestions: ['Buone sinergie'] },
    overallRating: 88,
    suggestions: [
      {
        type: 'suggestion',
