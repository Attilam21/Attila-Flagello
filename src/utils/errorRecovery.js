...
class ErrorRecoveryManager {
  ...
  setupDefaultHandlers() {
    ...
    this.errorHandlers.set(this.errorTypes.PERMISSION_ERROR, this.handlePermissionError.bind(this));
    this.errorHandlers.set(this.errorTypes.QUOTA_EXCEEDED, this.handleQuotaExceeded.bind(this));
    this.errorHandlers.set(this.errorTypes.UNAVAILABLE, this.handleUnavailable.bind(this));
    this.errorHandlers.set(this.errorTypes.TIMEOUT, this.handleTimeout.bind(this));
  }
  ...
  async executeWithRetry(operation, context = {}) {
    ...
    while (retryCount <= maxRetries) {
      try {
        ...
        retryCount++;
        console.log(`🔄 Tentativo ${retryCount}/${maxRetries} dopo ${response.delay}ms`);
...
export const useErrorRecovery = () => {
  ...
  return {
    recentErrors,
    clearErrors,
    handleError: errorRecoveryManager.handleFirebaseError.bind(errorRecoveryManager)
  };
};
